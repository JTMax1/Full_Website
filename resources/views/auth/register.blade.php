        ...
        <div class="w-4/12 bg-white p-6 rounded-lg">
            ...
            <form action="{{ route('register') }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    border-red-800 @enderror " value="{{old('name')}}">
                </div>
                <!-- the old('name') helps retain old data when user ommits a field -->
                <!-- the error('record') pops error in red when field is left blank-->
                ...
                <div class="mb-4">
                    ...
                    border-red-800 @enderror " value="{{old('username')}}">
                </div>
                ...
                <div class="mb-4">
                    ...
                    border-red-800 @enderror " value="{{old('email')}}">
                </div>
